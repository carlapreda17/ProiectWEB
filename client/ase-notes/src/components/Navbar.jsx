                ...
                <div className="flex items-center">
                    {isMainPage ? (
                        <div className="relative">
                            <button className={"inline"} onClick={toggleDropdown}>
                                <div>Nume</div>
                            ...
                            {dropdownVisible && (
                                <div className="absolute right-0 bg-white rounded-md shadow-md">
                                    <ul className={"pr-6"}>
                                        <li className={"flex"}>
                                            <a className={"flex gap-[0.5rem] w-full items-center"}>
                                                <p className={"text-[1.125rem]"}>Home</p>
                                                <div>
                                        ...
                                        <li className={"flex"}>
                                            <a className={"flex gap-[0.5rem] w-full items-center"}>
                                                <p className={"text-[1.125rem]"}>Settings</p>
                                                <div>
                                        ...
                                        <li className={"flex"}>
                                            <a className={"flex gap-[0.5rem] w-full items-center"}>
                                                <p className={"text-[1.125rem]"}>Sign out</p>
                                                <div>
                                                    <svg  xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 512 512">
